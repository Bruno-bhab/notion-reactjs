...
export function App() {
  return (
    <div className="min-h-screen text-zinc-50 p-8 bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400">
      <div className="bg-zinc-800 w-[1100px] mx-auto rounded-xl min-h-[720px] shadow-sm border-black/20 overflow-hidden grid grid-cols-[16rem_1fr]">
        <aside className="bg-zinc-900 border-r-zinc-100 p-4 flex flex-col gap-3 ">
          <div className="flex gap-2 group pb-6">
